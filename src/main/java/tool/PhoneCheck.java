...
public class PhoneCheck {
    ...
    public void phone(String phone_number,String actiCode) throws IOException, URISyntaxException{
        //修改为您的apikey.apikey可在官网（http://www.yunpian.com)登录后获取
        String apikey = "22c05646510f68fa42092c712962067a";

        //修改为您要发送的手机号
        String mobile = phone_number;

        /**************** 查账户信息调用示例 *****************/
        System.out.println(PhoneCheck.getUserInfo(apikey));

        /**************** 使用智能匹配模板接口发短信(推荐) *****************/
        //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
        String text = "【云片网】您的验证码是"+actiCode;
        System.out.println(PhoneCheck.sendSms(apikey, text, mobile));
