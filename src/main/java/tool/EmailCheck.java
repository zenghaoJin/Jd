...
public class EmailCheck {
    public void message(String email,String name,String acticode) throws GeneralSecurityException, MessagingException{
        ...
        StringBuffer sb=new StringBuffer("<div style=\"width:660px;overflow:hidden;border-bottom:" +
                ...
                "<br/><br/>欢迎，使用shopping.com购物网！<br/><br/>请点击下面链接激活账号，请尽快激活！</br>");
        sb.append("<a href=\"http://localhost:8080/Jd/emailCheck?name=");
        sb.append(name);
        sb.append("&acticode=");
        sb.append(acticode);
        sb.append("\">http://localhost:8080/Jd/emailCheck?name=");
        sb.append(name);
        sb.append("&acticode=");
        sb.append(acticode);
        sb.append("</a>"+"<br/>如果以上链接无法点击，请把上面网页地址复制到浏览器地址栏中打开<br/><br/><br/>shopping.com购物网<br/>"+bartDateFormat.format(new Date())+ "</div></div>" );
        msg.setSubject("Sp激活码");
